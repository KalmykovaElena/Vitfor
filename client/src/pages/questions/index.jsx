...
const getItems = () => [
  {
    ...
    children: (
      <p>
        Для регистрации на форуме VitFor необходимо, кликнув в правом верхнем углу значок Вход, ввести свою электронную
        почту и пароль из не менее 8-ми символов. Далее необходимо заполнить личную информацию (имя пользователя,
        отображаемое имя, дату рождения).
      </p>
    ),
    showArrow: false,
  },
    ...
    children: (
      <>
        <p>
          ...
          Например: Главная – Купи-продай – Подать объявление.
        </p>
  ...
  },
  {
    ...
    children: (
      <p>
        ...
        символы, которое Вы хотели бы найти на платформе. Поисковой запрос автоматически сгенерируется системой в
  ...
  },
  {
    ...
    children: (
      <p>
        Если Вы желаете сообщить о нарушении правил на форуме, обратитесь к модератору, кликнув вкладку «Вопрос-ответ»,
        или напишите на почту vitfor@dreamsoft.by.
      </p>
    ),
    showArrow: false,
  },
